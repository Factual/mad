...
export function getInfoByMarathonAppId(appId) {
  var idListPromise = getMarathonTaskId(appId);
  return getInfo(idListPromise)
}

export function getInfoByMesosTaskId(mesosTaskId) {
  var idListPromise = new Promise(resolve => resolve([mesosTaskId]));
  return getInfo(idListPromise)
}

function getInfo(idListPromise) {
